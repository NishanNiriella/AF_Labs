package com.sliit.sample.dal.adapter;

import com.sliit.sample.dal.model.PostModel;
import com.sliit.sample.dal.repository.PostMongoRepository;
...
public class PostDataAdapterMongoImpl implements PostDataAdapter {
    ...
    public Post update(Post post) {
        PostModel postModel = mongoTemplate
                .findAndModify(Query.query(Criteria.where("id").is(post.getId())),
